...
import Register from "../screens/unAuthentication/register/Register";
import Protector from "../screens/unAuthentication/register/Protector";
  ...
  return (
    ...
    >
      {!isLoading ? (
        token ? (
          <>
            <Stack.Screen component={MyDrawer} name="MyDrawer" />
            <Stack.Screen component={Quiz} name={QUIZ_SCREEN} />
            <Stack.Screen component={Detail} name={DETAIL} />
            <Stack.Screen component={MyPackScreen} name={MY_PACK} />
          </>
        ) : (
          <>
            <Stack.Screen
            ...
            <Stack.Screen component={Protector} name="Protector" />
            <Stack.Screen component={OnBoarding} name={ONBOARDING} />
            <Stack.Screen
              component={OnBoardingScroll}
              name={ONBOARDING_SCROLL}
            />
            <Stack.Screen component={OnBoardingEnd} name={ONBOARDING_END} />
          </>
        )
      ) : (
